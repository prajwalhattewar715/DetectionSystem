...
if "file" in form:
    ...
    if form_file.filename:
        ...
        uploaded_file_path = os.path.join(UPLOAD_DIR+"\\temp\\1\\", filename)
...
criminal=criminal_Prediction(filename)

print(criminal)
print("<html>")
print("<head>")
print("<meta http-equiv='refresh' content='0;url=http://localhost:8080/FromPythonPred?cate="+str(criminal)+"&sts=success'/>")
print("</head>")
print("</html>")
